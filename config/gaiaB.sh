...
NODE_GRPC_PORT_PREFIX="939"
NODE_GRPC_WEB_PORT_PREFIX="949"

# Local cluster file path base
## Account secrets, nodes data and configs, genesis, genTxs, etc.
CLUSTER_DIR="${HOME}/archway/local/${CHAIN_ID}"
